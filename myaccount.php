...
<form action="usersuggestion.php" method="get">
    <button type="submit"  class="links"><span class="glyphicon glyphicon-bullhorn"></span>SUGGESTION
<?php
...
<form action="usermessage.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-envelope"></span>MESSAGE
               <?php
...
<form action="userratingpage.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-signal"></span>RATE-US</button>
</form>
...
?>
 ...
 <p><button type="submit" id="javascript"  ></button></p>
</div>
    </div>
  ...
  <footer id="footer" class="footer" >
    <div class="container text-center">
      ...
      <h3><b>!!!SUGGUESTIONS ARE WELCOMED!!!</h3>
